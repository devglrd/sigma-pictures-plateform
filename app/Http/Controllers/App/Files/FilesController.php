...
class FilesController extends Controller
{
    ...
    public function postFile(Request $request)
    {
        ...
        if (!$request->file->getClientOriginalExtension() == "png" || !$request->file->getClientOriginalExtension() == "raw" || !$request->file->getClientOriginalExtension() == "mov" || !$request->file->getClientOriginalExtension() == "mp4" || !$request->file->getClientOriginalExtension() == "jpeg" || !$request->file->getClientOriginalExtension() == "wave" || !$request->file->getClientOriginalExtension() == "mp3") {
